...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1006637374182').split()]
...
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'zipshortnet.net')
