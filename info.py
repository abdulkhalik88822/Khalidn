...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002032241046').split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 't.me/dragonmoviebots')
